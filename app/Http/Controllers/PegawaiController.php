...
class PegawaiController extends Controller
{
    ...
    public function index()
    {
        ...
        $pegawai = User::where('is_admin', 0)->get()->map(function ($pegawai) use ($provinsis) {
            ...
            $responseKecamatan = Http::get("https://wilayah.id/api/districts/{$pegawai->kabupaten}.json");
            ...
            // Mengambil data kecamatan berdasarkan ID kabupaten
            $responseKelurahan = Http::get("https://wilayah.id/api/villages/{$pegawai->kecamatan}.json");
